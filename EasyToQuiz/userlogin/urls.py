...
from .views import login, userregistration,welcome,logout,createquiz,savingquiz, submit,quiznext2,btw_submit,responses_data,responses,view_response,change_data
urlpatterns=[
